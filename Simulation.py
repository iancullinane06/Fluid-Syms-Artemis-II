...
from Mechanisms.Graphing import update_progress_bar
from Mechanisms.Visualisation import build_and_render_visualisations
...
limits = {
    ...
    "global_min_pressure": global_min_pressure,
    "global_max_pressure": global_max_pressure,
    "global_min_density": global_min_density,
    "global_max_density": global_max_density,
    "global_min_temperature": global_min_temperature,
    "global_max_temperature": global_max_temperature,
    "global_min_mach": global_min_mach,
    "global_max_mach": global_max_mach,
    "global_max_shear": global_max_shear,
}

build_and_render_visualisations(
    ...
    sim_speed_scale=SIM_SPEED_SCALE,
    figure_height_scale=FIGURE_HEIGHT_SCALE,
    limits=limits,
